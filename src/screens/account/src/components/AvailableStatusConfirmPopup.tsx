...
interface IAvailableStatusConfirmPopupProps {
  onConfirm?: () => void;
  price?: string;
  title?: string;
  text?: string;
...
export interface IAvailableStatusConfirmPopupRef {
  showModal?: () => void;
  hideModal?: () => void;
}

const AvailableStatusConfirmPopup = (props: IAvailableStatusConfirmPopupProps, ref: React.Ref<IAvailableStatusConfirmPopupRef>) => {
...
export default forwardRef(AvailableStatusConfirmPopup);
