...
const TourStatusConfirmPopup = (props: ITourStatusConfirmPopupProps, ref: React.Ref<IConfirmPopupRef>) => {
    ...
    >
      <View style={styles.container}>
        ...
        <View style={styles.groupButton}>
          ...
          <Button title="Từ chối" customStyles={styles.buttonReject} disableGradient onPress={handleReject} />
