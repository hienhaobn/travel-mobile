...
const HomeOptions = () => {
  ...
  return (
    <ScrollView horizontal style={styles.optionsContainer}>
      ...
      <TouchableOpacity style={[styles.optionItem, styles.mh5]} onPress={() => navigate('ListTourScreen')}>
      ...
      <TouchableOpacity style={[styles.optionItem, styles.mh5]} onPress={() => navigate('ListPostScreen')}>
